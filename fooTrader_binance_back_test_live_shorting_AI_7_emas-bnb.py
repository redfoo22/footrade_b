...
def BUY_MARKET():
    ...
    if STATE["live"]==0 and STATE["long"]==0:
        ...
        if STATE["simulation"]==0:
            ...
            print("tick highs array",ai.max_tick_highs)
...
def on_message(ws,message):
    ...
    try:    
        ...
        # prinst(f'tick high EMA: {ai.tick_highs_EMA(tick_price,2)}')
        ...
        #BUY AND SELL
        buy_low_sell_high(tick_price,ai.tick_lows_EMA(tick_price,2),ai.tick_highs_EMA(tick_price,2),ai.get_tick_EMA(tick_price,8))
