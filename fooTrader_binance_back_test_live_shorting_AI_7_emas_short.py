...
def BUY_MARKET():
    ...
    if STATE["live"]==0 and STATE["long"]==0 and nap_bar >= 0:
        #state
        ...
        # else:
            ...
            trail_stop_price = avg_trade_entry_price - avg_trade_entry_price *.0065
...
def SHORT():
    ...
    if STATE["simulation"] ==0:
        ...
        if STATE["live"]==0 and STATE["short"]==0:
            ...
            print("min tick lows array",ai.min_tick_lows)
...
def SHORT_CLOSE():
    ...
    if STATE["live"]==1 and STATE["short"]==1:
        ...
        # else:
            ...
            print(f'SHORT CLOSSSSSED running prof:{running_profit * SHARES},GAMES {STATE["games"]} WINS:{STATE["wins"]} LEARNS: {STATE["learns"]}')
...
def buy_low_sell_high(tick,low_item,high_item,EMA_item):
    global STATE
    global CANDLES
    
    #short close
    if tick < low_item:
        if high_item < EMA_item:
    ...
    try:    
        ...
        #record Data!!!!
            ...
            #record Data!!!!
                ...
                print(f' Date: {CANDLES[-1]["date"]} CLOSE: {CANDLES[-1]["close"]} EMA1: {CANDLES[-1]["EMA1"]} EMA2: {CANDLES[-1]["EMA2"]} ENTRY: {avg_trade_entry_price}')
        ...
        #BUY AND SELL
        buy_low_sell_high(tick_price,ai.tick_lows_EMA(tick_price,2),ai.tick_highs_EMA(tick_price,2),ai.get_tick_EMA(tick_price,EMA1_WINDOW))
