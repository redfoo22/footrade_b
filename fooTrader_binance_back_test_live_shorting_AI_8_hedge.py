...
class Hedge():
    ...
    def BUY_MARKET(self):
        ...
        if STATE["simulation"]==0:
            ...
            #make Row
            row = {"ID":self.add_ID(),"entry_date":datetime.datetime.now(),"exit_date":None,"entry_price":self.entry_price,"exit_price":0,"shares":self.SHARES,"symbol":self.TRADE_SYMBOL,"tp_price": self.tp_price(self.entry_price),"long":1,"short":0,"open":1,"closed":0,"profit":0}
