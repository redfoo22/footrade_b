...
def BUY_MARKET():
    ...
    if STATE["live"]==0 and STATE["long"]==0:
        ...
        email_Text(f'Entry {avg_trade_entry_price}', f' Trail: {trail_stop_price} STATE: {STATE["live"]} , {STATE["long"]} ')
...
def SELL_MARKET():
    ...
    if STATE["live"]==1 and STATE["long"]==1:
        ...
        email_Text(f'Exit {avg_trade_exit_price}', f'STATE: {STATE["live"]} , {STATE["long"]} ')
        print("Sleeping")
        time.sleep(2)
